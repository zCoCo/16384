function [ frames ] = forward_kinematics_COM_RR(theta)
...
H_1_0 = [c1, -s1, 0; s1, c1, 0; 0,0,1] * [1, 0, l1/2; 0,1,0; 0,0,1]; % transform to COM of link 1
H_j2_1 = [c2, -s2, l1/2; s2, c2, 0; 0,0,1]; % translate then rotate to joint 2
H_2_0 = H_1_0 * H_j2_1 * [1, 0, l2/2; 0,1,0; 0,0,1]; % transform to COM of link 2
